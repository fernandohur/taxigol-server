...
class Service < ActiveRecord::Base
  ...
  ## Attributes ##
  ################
  attr_accessible :taxi_id, :verification_code, :address, :latitude, :longitude,:state,:tip
  belongs_to :taxi
  ...
  #
  def Service.construct(verification_code, address, latitude=nil, longitude=nil, tip='')
    s = Service.new(
